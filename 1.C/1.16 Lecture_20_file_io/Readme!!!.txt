Задачите по-долу са вмъкнати като решение в основната задача от файла RentACARMain.c
NB: За сега, заданието за delete на марка беше дискутирано да отпадне.

Задачи за самоподготовка (лекция 20)
