...
{
    40,
    "../7_Library/ProCsource/insertInvoice.pc"
};


static unsigned int sqlctx = 84983763;
...
28,0,0,2,65,0,4,47,0,0,2,1,0,1,0,2,3,0,0,1,3,0,0,
51,0,0,3,140,0,3,58,0,0,7,7,0,1,0,1,97,0,0,1,4,0,0,1,0,0,0,1,97,0,0,1,97,0,0,1,
3,0,0,1,3,0,0,
};
...
l_reference=:b1";
    ...
    sqlstm.sqhstv[0] = (unsigned char  *)&customer_id;
    ...
    sqlstm.sqhstv[1] = (unsigned char  *)externalReference;
    ...
    if (sqlca.sqlcode < 0) sql_error(ORA_ERR_FORMAT_12);
}
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select (max(seq)+1) into :b0  from invoices where custome\
r_id=:b1";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (unsigned char  *)&customer_id;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into invoices (inv_no,amount,amount_due,currency,i\
ssue_date,customer_id,seq) values (:b0,:b1,:b1,:b3,TO_DATE(:b4,'YYYYMMDD'),:b5\
,:b6)";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (unsigned char  *)newInv_no;
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (unsigned char  *)&invoiceAmt;
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (unsigned char  *)&invoiceAmt;
    ...
    sqlstm.sqhstv[3] = (unsigned char  *)invCurrency;
    ...
    sqlstm.sqhstv[5] = (unsigned char  *)&customer_id;
    ...
    sqlstm.sqhstv[6] = (unsigned char  *)&maxSeq;
